...
def adjust_q(loss_main, loss_data, initial_loss=5.99, thresh=1, q0=0.5, alpha=1):
    q = q0 + (1-q0) * max(0, loss_data - thresh) / (initial_loss - thresh) * (alpha * (loss_main/loss_data - 1) + 1)
    return q
